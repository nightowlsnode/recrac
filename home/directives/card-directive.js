    ...
    return {
      ...
      controller: function ($scope, $http, $state) {
        $scope.joinEventHandler = function(joinedEvent) {
          console.log('CLICK HANDLE scope', $scope);
          console.log('joinedEvent', joinedEvent);
          // console.log('advanced', $scope.showAdvanced);
          // console.log('advancedBid', $scope.showAdvancedBid);
          $scope.$root.event = joinedEvent;
          $scope.showAdvancedBid(joinedEvent);
